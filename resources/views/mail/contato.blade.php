...
@endif
    ...
    <section class="bg-gray-900">
        <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <p class="mb-8 lg:mb-16 font-light text-center text-gray-400 sm:text-xl">Deseja ter seu próprio site online? Entre em contato comigo.</p>
            ...
            <form action="{{ route('mail.contato') }}" method="POST" class="space-y-8">
                ...
                <div>
                    ...
                    <input name="email" type="email" id="email" class="shadow-sm bg-gray-50 border text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500 shadow-sm-light" required>
                </div>
                <div>
                ...
                <button type="submit" class="text-gray-200 block rounded-lg text-center font-medium leading-6 px-6 py-3 bg-blue-500 hover:bg-sky-900 hover:text-white">Enviar mensagem</button>
            </form>
